...
(1, 1, 1, 'Completed', 1, '2025-01-25', '2025-01-25', 'BP 120, HR 70 bpm, Temp 36.5 C', 'Baseline visit, patient tolerating treatment well'),
(1, 1, 1, 'Completed', 2, '2025-02-25', '2025-02-25', 'BP 120, HR 70 bpm, Temp 36.5 C', 'Follow-up visit, no significant changes reported'),
(2, 1, 1, 'Completed', 1, '2025-01-26', '2025-01-26', 'BP 121, HR 71 bpm, Temp 36.5 C', 'Baseline visit, patient tolerating treatment well'),
(2, 1, 1, 'Completed', 2, '2025-02-26', '2025-02-26', 'BP 121, HR 71 bpm, Temp 36.5 C', 'Follow-up visit, no significant changes reported'),
(3, 1, 1, 'Completed', 1, '2025-01-27', '2025-01-27', 'BP 122, HR 72 bpm, Temp 36.5 C', 'Baseline visit, patient tolerating treatment well'),
(3, 1, 1, 'Completed', 2, '2025-02-27', '2025-02-27', 'BP 122, HR 72 bpm, Temp 36.5 C', 'Follow-up visit, no significant changes reported'),
(4, 1, 1, 'Completed', 1, '2025-01-28', '2025-01-28', 'BP 123, HR 73 bpm, Temp 36.5 C', 'Baseline visit, patient tolerating treatment well'),
(4, 1, 1, 'Completed', 2, '2025-02-28', '2025-02-28', 'BP 123, HR 73 bpm, Temp 36.5 C', 'Follow-up visit, no significant changes reported'),
(5, 1, 1, 'Completed', 1, '2025-01-28', '2025-01-28', 'BP 124, HR 74 bpm, Temp 36.5 C', 'Baseline visit, patient tolerating treatment well'),
(5, 1, 1, 'Completed', 2, '2025-02-28', '2025-02-28', 'BP 124, HR 74 bpm, Temp 36.5 C', 'Follow-up visit, no significant changes reported'),
(6, 3, 2, 'Completed', 1, '2025-06-10', '2025-06-10', 'BP 118, HR 68 bpm, Temp 36.6 C', 'Screening and enrollment visit'),
(6, 3, 2, 'Completed', 2, '2025-07-10', '2025-07-10', 'BP 118, HR 68 bpm, Temp 36.6 C', 'Routine safety follow-up'),
(7, 3, 2, 'Completed', 1, '2025-06-13', '2025-06-13', 'BP 119, HR 69 bpm, Temp 36.6 C', 'Screening and enrollment visit'),
(7, 3, 2, 'Completed', 2, '2025-07-13', '2025-07-13', 'BP 119, HR 69 bpm, Temp 36.6 C', 'Routine safety follow-up'),
(8, 3, 2, 'Completed', 1, '2025-06-16', '2025-06-16', 'BP 120, HR 70 bpm, Temp 36.6 C', 'Screening and enrollment visit'),
(8, 3, 2, 'Scheduled', 2, '2025-07-16', NULL, NULL, 'Routine safety follow-up'),
(9, 3, 2, 'Completed', 1, '2025-06-19', '2025-06-19', 'BP 121, HR 71 bpm, Temp 36.6 C', 'Screening and enrollment visit'),
(9, 3, 2, 'Scheduled', 2, '2025-07-19', NULL, NULL, 'Routine safety follow-up'),
(10, 5, 3, 'Completed', 1, '2024-09-15', '2024-09-15', 'BP 130, HR 75 bpm, Temp 36.7 C', 'Baseline tumor assessment via imaging'),
(10, 5, 3, 'Completed', 2, '2024-11-15', '2024-11-15', 'BP 130, HR 75 bpm, Temp 36.7 C', 'Follow-up imaging and response evaluation'),
(11, 5, 3, 'Completed', 1, '2024-09-18', '2024-09-18', 'BP 131, HR 76 bpm, Temp 36.7 C', 'Baseline tumor assessment via imaging'),
(11, 5, 3, 'Completed', 2, '2024-11-18', '2024-11-18', 'BP 131, HR 76 bpm, Temp 36.7 C', 'Follow-up imaging and response evaluation'),
(12, 5, 3, 'Completed', 1, '2024-09-21', '2024-09-21', 'BP 132, HR 77 bpm, Temp 36.7 C', 'Baseline tumor assessment via imaging'),
(12, 5, 3, 'Completed', 2, '2024-11-21', '2024-11-21', 'BP 132, HR 77 bpm, Temp 36.7 C', 'Follow-up imaging and response evaluation'),
(13, 5, 3, 'Completed', 1, '2024-09-24', '2024-09-24', 'BP 133, HR 78 bpm, Temp 36.7 C', 'Baseline tumor assessment via imaging'),
(13, 5, 3, 'Completed', 2, '2024-11-24', '2024-11-24', 'BP 133, HR 78 bpm, Temp 36.7 C', 'Follow-up imaging and response evaluation'),
(14, 5, 3, 'Completed', 1, '2024-09-27', '2024-09-27', 'BP 134, HR 79 bpm, Temp 36.7 C', 'Baseline tumor assessment via imaging'),
(14, 5, 3, 'Completed', 2, '2024-11-27', '2024-11-27', 'BP 134, HR 79 bpm, Temp 36.7 C', 'Follow-up imaging and response evaluation'),
(15, 7, 4, 'Completed', 1, '2023-03-10', '2023-03-10', 'BP 100, HR 80 bpm, Temp 37.2 C', 'COVID-19 treatment day 1, monitoring respiratory function'),
(15, 7, 4, 'Completed', 2, '2023-04-10', '2023-04-10', 'BP 100, HR 80 bpm, Temp 36.9 C', 'COVID-19 treatment day 2, monitoring respiratory function'),
(15, 7, 4, 'Completed', 3, '2023-05-10', '2023-05-10', 'BP 100, HR 80 bpm, Temp 36.6 C', 'COVID-19 treatment day 3, monitoring respiratory function'),
(16, 7, 4, 'Completed', 1, '2023-03-13', '2023-03-13', 'BP 101, HR 81 bpm, Temp 37.2 C', 'COVID-19 treatment day 1, monitoring respiratory function'),
(16, 7, 4, 'Completed', 2, '2023-04-13', '2023-04-13', 'BP 101, HR 81 bpm, Temp 36.9 C', 'COVID-19 treatment day 2, monitoring respiratory function'),
(16, 7, 4, 'Completed', 3, '2023-05-13', '2023-05-13', 'BP 101, HR 81 bpm, Temp 36.6 C', 'COVID-19 treatment day 3, monitoring respiratory function'),
(17, 7, 4, 'Completed', 1, '2023-03-16', '2023-03-16', 'BP 102, HR 82 bpm, Temp 37.2 C', 'COVID-19 treatment day 1, monitoring respiratory function'),
(17, 7, 4, 'Completed', 2, '2023-04-16', '2023-04-16', 'BP 102, HR 82 bpm, Temp 36.9 C', 'COVID-19 treatment day 2, monitoring respiratory function'),
(17, 7, 4, 'Completed', 3, '2023-05-16', '2023-05-16', 'BP 102, HR 82 bpm, Temp 36.6 C', 'COVID-19 treatment day 3, monitoring respiratory function'),
(18, 7, 4, 'Completed', 1, '2023-03-19', '2023-03-19', 'BP 103, HR 83 bpm, Temp 37.2 C', 'COVID-19 treatment day 1, monitoring respiratory function'),
(18, 7, 4, 'Completed', 2, '2023-04-19', '2023-04-19', 'BP 103, HR 83 bpm, Temp 36.9 C', 'COVID-19 treatment day 2, monitoring respiratory function'),
(18, 7, 4, 'Completed', 3, '2023-05-19', '2023-05-19', 'BP 103, HR 83 bpm, Temp 36.6 C', 'COVID-19 treatment day 3, monitoring respiratory function'),
(19, 9, 1, 'Completed', 1, '2025-02-05', '2025-02-05', 'BP 125, HR 72 bpm, Temp 36.5 C', 'Baseline lipid panel and cardiovascular assessment'),
(19, 9, 1, 'Completed', 2, '2025-05-05', '2025-05-05', 'BP 125, HR 72 bpm, Temp 36.5 C', 'Follow-up lipid panel'),
(20, 9, 1, 'Completed', 1, '2025-02-09', '2025-02-09', 'BP 126, HR 73 bpm, Temp 36.5 C', 'Baseline lipid panel and cardiovascular assessment'),
(20, 9, 1, 'Completed', 2, '2025-05-09', '2025-05-09', 'BP 126, HR 73 bpm, Temp 36.5 C', 'Follow-up lipid panel'),
(21, 9, 1, 'Completed', 1, '2025-02-13', '2025-02-13', 'BP 127, HR 74 bpm, Temp 36.5 C', 'Baseline lipid panel and cardiovascular assessment'),
(21, 9, 1, 'Completed', 2, '2025-05-13', '2025-05-13', 'BP 127, HR 74 bpm, Temp 36.5 C', 'Follow-up lipid panel'),
(22, 9, 1, 'Completed', 1, '2025-02-17', '2025-02-17', 'BP 128, HR 75 bpm, Temp 36.5 C', 'Baseline lipid panel and cardiovascular assessment'),
(22, 9, 1, 'Completed', 2, '2025-05-17', '2025-05-17', 'BP 128, HR 75 bpm, Temp 36.5 C', 'Follow-up lipid panel'),
(23, 9, 1, 'Completed', 1, '2025-02-21', '2025-02-21', 'BP 129, HR 76 bpm, Temp 36.5 C', 'Baseline lipid panel and cardiovascular assessment'),
(23, 9, 1, 'Completed', 2, '2025-05-21', '2025-05-21', 'BP 129, HR 76 bpm, Temp 36.5 C', 'Follow-up lipid panel'),
(24, 11, 6, 'Scheduled', 1, '2026-07-20', NULL, NULL, 'Initial screening visit pending'),
(25, 11, 6, 'Scheduled', 1, '2026-07-22', NULL, NULL, 'Initial screening visit pending'),
(26, 11, 6, 'Scheduled', 1, '2026-07-24', NULL, NULL, 'Initial screening visit pending'),
(27, 13, 2, 'Completed', 1, '2024-05-15', '2024-05-15', 'BP 140, HR 88 bpm, Temp 37.0 C', 'Patient reported severe adverse reaction, withdrew consent after this visit'),
(28, 13, 2, 'Completed', 1, '2024-05-20', '2024-05-21', 'BP 138, HR 85 bpm, Temp 36.9 C', 'Patient withdrew due to personal reasons unrelated to treatment'),
(29, 15, 8, 'Scheduled', 1, '2026-08-01', NULL, NULL, 'Initial screening visit pending'),
(30, 15, 8, 'Scheduled', 1, '2026-08-05', NULL, NULL, 'Initial screening visit pending');
GO
